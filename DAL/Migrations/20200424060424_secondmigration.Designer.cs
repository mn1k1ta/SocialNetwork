...
namespace DAL.Migrations
{
    ...
    [Migration("20200424060424_secondmigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DAL.Model.Friends", b =>
                {
            ...
            modelBuilder.Entity("DAL.Model.UserProfile", b =>
                {
                    b.Property<int>("UserProfileId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DAL.Model.UserProfile", b =>
                {
                    b.HasOne("DAL.Model.ApplicationUser", "ApplicationUser")
                        .WithOne("UserProfile")
                        .HasForeignKey("DAL.Model.UserProfile", "AplicationUserId");
                });
